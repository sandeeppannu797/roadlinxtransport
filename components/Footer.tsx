...
import { ADDRESS, FACEBOOK_URL, GOOGLE_PROFILE_URL, MAPS_URL } from '@/lib/site';
...
/* Company pages, several of which had no other link from the footer. */
const footerCompany = [
      ...
      <div className="footer-main">
        <div className="container footer-grid">
          <div className="footer-brand">
            <Link href="/"><img src="/assets/img/roadlinx-logo.png" alt="Road Linx Transport" width={200} height={100} loading="lazy" /></Link>
            ...
            <div className="chip-row" style={{ marginTop: 20 }}>
              ...
              <span className="chip"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1Z"/></svg>COR trained</span>
            </div>
            <div className="footer-social">
              <a href={GOOGLE_PROFILE_URL} target="_blank" rel="noopener">Google reviews</a>
          ...
          <div className="footer-col footer-contact">
            ...
            <div className="fc-row">
              ...
              <span style={{ color: 'var(--text-on-navy-muted)' }}>
                <a href={MAPS_URL} target="_blank" rel="noopener" style={{ fontWeight: 'inherit', color: 'inherit' }}>{ADDRESS.street}<br />{ADDRESS.suburb} {ADDRESS.state} {ADDRESS.postcode}</a>
                <br />Serving SE QLD &amp; Northern NSW
              </span>
            </div>
